defmodule ClaperWeb.EventLive.ManageInteractionListComponent do
        ...
        <div class="static" x-data="{ open: false }" @click.outside="open = false">
          ...
          >
            ...
            <.popup_item
              ...
              description={gettext("Collect short answers and show them as a live word cloud.")}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="h-5 w-5"
            ...
            <.popup_item
              patch={~p"/e/#{@event_code}/manage/add/open_ended"}
              title={gettext("Open ended")}
              description={gettext("Collect free-text responses and show them as cards.")}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="h-5 w-5"
  ...
  defp type_key(%Claper.OpenEnded.OpenEnded{}), do: "open_ended"
  ...
  defp type_label(%Claper.OpenEnded.OpenEnded{}), do: gettext("Open ended")
  ...
  defp edit_path(event_code, %Claper.OpenEnded.OpenEnded{id: id}),
    do: ~p"/e/#{event_code}/manage/edit/open_ended/#{id}"
  ...
  defp toggle_event(%Claper.WordClouds.WordCloud{enabled: true}), do: "word_cloud-set-inactive"
  defp toggle_event(%Claper.WordClouds.WordCloud{enabled: false}), do: "word_cloud-set-active"
  defp toggle_event(%Claper.OpenEnded.OpenEnded{enabled: true}), do: "open_ended-set-inactive"
  defp toggle_event(%Claper.OpenEnded.OpenEnded{enabled: false}), do: "open_ended-set-active"
