defmodule ClaperWeb.Router do
  ...
  pipeline :office_api do
    plug(:accepts, ["json"])
    plug(ClaperWeb.Plugs.OfficeAuthPlug)
  end
  ...
  live_session :user,
    ...
    scope "/", ClaperWeb do
      ...
      post "/export/open_ended/:open_ended_id", StatController, :export_open_ended
  ...
  live_session :presenter, on_mount: ClaperWeb.UserLiveAuth do
    scope "/", ClaperWeb do
      ...
      live("/e/:code/manage/add/open_ended", EventLive.Manage, :add_open_ended)
      live("/e/:code/manage/edit/open_ended/:id", EventLive.Manage, :edit_open_ended)
  ...
  scope "/office", ClaperWeb.Office do
    pipe_through([:api])
    get("/manifest.xml", ManifestController, :show)
  end

  ## Office API (PowerPoint add-in)
  scope "/api/office", ClaperWeb.Office do
    pipe_through([:office_api])

    post("/auth/token", AuthController, :token)
    get("/events", EventController, :index)
    get("/events/:id", EventController, :show)
    get("/events/:id/interactions", EventController, :interactions)
    get("/events/:id/state", EventController, :state)
    get("/events/:id/posts", EventController, :posts)
    get("/interactions/:id", InteractionController, :show)
    get("/interactions/:id/results", InteractionController, :results)
    post("/interactions/:id/activate", InteractionController, :activate)
    post("/interactions/:id/deactivate", InteractionController, :deactivate)
  end
